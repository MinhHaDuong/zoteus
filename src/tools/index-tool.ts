...
const indexTool: ToolDefinition = {
  ...
  handler: async (args, ctx) => {
    ...
    const opts = { fulltext, fulltextMaxChars: args.fulltext_max_chars, fresh: args.action === 'refresh' };
