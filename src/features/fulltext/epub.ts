...
/**
 * Re-exported from lib rather than defined here: notes in the search index need the same
 * stripper, and this module (a zip reader) is not where a second feature should import it
 * from. Every existing importer still resolves it here.
 */
export { htmlToText } from '../../lib/html-text.js';
