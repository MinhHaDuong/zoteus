...
import { pruneTerms, MIN_SNIPPET_TERMS, type HighDf } from './droplist.js';
 ...
 */
export function makeSnippet(text: string, query: string, max = 240, highDf?: HighDf): string {
  ...
  let pos = -1;
  for (const t of pruneTerms(tokenize(query), highDf, MIN_SNIPPET_TERMS)) {
